...
class View {
    ...
    handleTileClick(location) {
        ...
        // crazy town for switching perspective for other player to play
...
class Control {
    ...
    autoplay() {
        // change this.game.turn === "BLACK" to "BLACK WHITE" for auto mode or ai against ai :applicable or betting formation
        const input = this.game.turn === "BLACK" ? this.inputRandomWhite : this.inputRandomBlack;
        if (!input.checked) {
